local function WhitePaws_Command(arg1)
	...
	SELECTED_CHAT_FRAME:AddMessage((wcFlightMaster and '[|cff00ff00开|r]' or '[|cffff0000关|r]')..'/wc speed 开关小地图右下方移动速度显示框体',255,255,0)
	SELECTED_CHAT_FRAME:AddMessage((wcSpeed and '[|cff00ff00开|r]' or '[|cffff0000关|r]')..'/wc fly 开关点击飞行点地图自动取消变形功能',255,255,0)
